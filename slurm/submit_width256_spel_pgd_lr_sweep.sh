...
echo "  branch=${SPEL_PGD_BRANCH_MODE}, projection=${SPEL_PGD_PROJECTION_MODE}, gap=${SPEL_PGD_GAP_THRESHOLD_REL}, sigma2_steps=${SPEL_PGD_SIGMA2_POWER_ITERATION_STEPS}"
