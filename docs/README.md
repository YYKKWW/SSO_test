...
| Document | Purpose |
|---|---|
| [experiments/width256_sso_mcsd_lr_sweep_1b.md](experiments/width256_sso_mcsd_lr_sweep_1b.md) | Main width-256/512 optimizer LR sweep on the 1B-token OLMo mix sample, covering SSO, MCSD/SpEL, MCSD-PGD, and the 250M-token MCSD-PGD projection tuning run. |
