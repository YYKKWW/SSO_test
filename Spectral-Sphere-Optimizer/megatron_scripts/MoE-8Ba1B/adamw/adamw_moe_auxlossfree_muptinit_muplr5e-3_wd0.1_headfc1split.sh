...
REPO_PATH="results/optimizer_arena_v2/MoE_8Ba1B"
JOB_NAME=adamw_moe_auxlossfree_muptinit_muplr5e-3_wd0.1_headfc1split
...
MODEL_ARGS=(
    ...
    --moe-router-topk-scaling-factor 2
...
LOGGER_ARGS=(
    ...
    --log-hidden-states embeddings input_layernorm attention::linear_qkv attention::linear_q attention::linear_k attention::linear_v attention::core_attention attention::o_proj pre_mlp_layernorm mlp moe::router moe::shared_experts moe::routed_experts
