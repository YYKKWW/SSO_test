...
#
# This variant defaults to 1B training tokens instead of 10B.
# Start with DRY_RUN=1 to print the manifest. Use SMOKE=1 before launching.

WORKSPACE=${WORKSPACE:-/workspace}
REPO_PATH=${REPO_PATH:-${WORKSPACE}/results/optimizer_arena_v2/single_gpu_1b_paperarch}
SESSION_NAME=${SESSION_NAME:-single_gpu_1b_paperarch_spel}
...
if [ "$SMOKE" = "1" ]; then
    ...
    JOB_NAME=${JOB_NAME:-paperarch_1b_width256_smoke} \
...
echo "Single-GPU 1B paper-architecture sweep"
