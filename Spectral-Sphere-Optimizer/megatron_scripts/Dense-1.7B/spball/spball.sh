...
# Single-run Spectral Ball launcher derived from the completed true-SpEL h2048 setup.
...
#   HIDDEN_SIZE=256 LR=5e-3 bash spball.sh
#   HIDDEN_SIZE=512 LR=5e-3 bash spball.sh
...
REPO_PATH=${REPO_PATH:-${WORKSPACE}/results/optimizer_arena_v2/true_spball_from_h2048_ref}
job_lr=${LR//./p}
job_lr=${job_lr//-/m}
JOB_NAME=${JOB_NAME:-mup_spectral_ball_dist_h${HIDDEN_SIZE}_lr${job_lr}}
